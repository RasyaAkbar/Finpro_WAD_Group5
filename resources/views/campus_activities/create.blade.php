...
@section('title', 'Create Campus Activity - inTel-U')
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Add an exciting new campus activity for students</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white/60 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-xl">
            <form action="{{route('student.campus-activities-store') }}" method="POST" class="space-y-6">
                @csrf
