...
<div class="pt-24 pb-10 bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen px-4">
    <div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow">
        <h1 class="text-2xl font-bold text-blue-800 mb-4">Add New Competition</h1>
        ...
        <form method="POST" action="{{ route('admin.competitions.store') }}">
            ...
            <textarea name="description" id="description" class="w-full p-2 border rounded mb-4" required>{{ old('description') }}</textarea>
